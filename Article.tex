...
$$
\begin{array}{l}
\hbox{\sanhao 论\hspace{.8mm}文\hspace{.8mm}题\hspace{.8mm}目：}\hspace{3.6mm}$\underline{\makebox[12cm][l]{\sanhao 浅议紧算子及其应用}}$\\[5.5mm]
...
\hbox{姓\hspace{10.5mm}名：}\hspace{8mm}$\underline{\makebox[12cm][l]{安昭龙}}$\\[5.5mm]
\hbox{学\hspace{10.5mm}号：}\hspace{8mm}$\underline{\makebox[12cm][l]{20191236}}$\\[5.5mm]
\hbox{指导教师：}\hspace{8mm}$\underline{\makebox[12cm][l]{王士模}}$
\end{array}
$$
}
\vspace{24mm}
